...
opt1 = Option.create(option: 'Java')
opt2 = Option.create(option: 'JavaScript')
opt3 = Option.create(option: 'Ruby')
opt4 = Option.create(option: 'Python')
opt5 = Option.create(option: 'Cobra')
opt6 = Option.create(option: 'Rattle')
opt7 = Option.create(option: 'Black mamba')
opt8 = Option.create(option: 'Cat')
opt9 = Option.create(option: 'Dog')

poll1 = Poll.new(question: 'Your fav language', user_id: admin.id)
...
poll3 = Poll.create(question: 'What do you like the most', user_id: user2.id)
