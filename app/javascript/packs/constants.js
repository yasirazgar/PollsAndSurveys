...
export const AVAILABLE_MODALS = [PROFILE_MODAL, SIGN_IN_MODAL, SIGN_UP_MODAL]

export const PROFILE_BUTTON = 'PROFILE_BUTTON'
export const SIGN_IN_BUTTON = 'SIGN_IN_BUTTON'
export const SIGN_UP_BUTTON = 'SIGN_UP_BUTTON'
export const AVAILABLE_BUTTONS = [PROFILE_BUTTON, SIGN_IN_BUTTON, SIGN_UP_BUTTON]
